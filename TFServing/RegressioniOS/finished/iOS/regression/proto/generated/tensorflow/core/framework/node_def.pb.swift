...
public struct Tensorflow_NodeDef {
  ...
  public var experimentalDebugInfo: Tensorflow_NodeDef.ExperimentalDebugInfo {
    get {return _experimentalDebugInfo ?? Tensorflow_NodeDef.ExperimentalDebugInfo()}
    set {_experimentalDebugInfo = newValue}
  }
  /// Returns true if `experimentalDebugInfo` has been explicitly set.
  public var hasExperimentalDebugInfo: Bool {return self._experimentalDebugInfo != nil}
  /// Clears the value of `experimentalDebugInfo`. Subsequent reads from it will return its default value.
  public mutating func clearExperimentalDebugInfo() {self._experimentalDebugInfo = nil}
  ...
  /// function type.
  public var experimentalType: Tensorflow_FullTypeDef {
    get {return _experimentalType ?? Tensorflow_FullTypeDef()}
    set {_experimentalType = newValue}
  }
  /// Returns true if `experimentalType` has been explicitly set.
  public var hasExperimentalType: Bool {return self._experimentalType != nil}
  /// Clears the value of `experimentalType`. Subsequent reads from it will return its default value.
  public mutating func clearExperimentalType() {self._experimentalType = nil}
  ...
  public struct ExperimentalDebugInfo {
    ...
    public var originalFuncNames: [String] = []
  ...
  fileprivate var _experimentalDebugInfo: Tensorflow_NodeDef.ExperimentalDebugInfo? = nil
  fileprivate var _experimentalType: Tensorflow_FullTypeDef? = nil
}
...
extension Tensorflow_NodeDef: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Tensorflow_AttrValue>.self, value: &self.attr) }()
