...
extension Tensorflow_TensorProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularEnumField(value: &_storage._dtype) }()
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._tensorShape) }()
        case 3: try { try decoder.decodeSingularInt32Field(value: &_storage._versionNumber) }()
        case 4: try { try decoder.decodeSingularBytesField(value: &_storage._tensorContent) }()
        case 5: try { try decoder.decodeRepeatedFloatField(value: &_storage._floatVal) }()
        case 6: try { try decoder.decodeRepeatedDoubleField(value: &_storage._doubleVal) }()
        case 7: try { try decoder.decodeRepeatedInt32Field(value: &_storage._intVal) }()
        case 8: try { try decoder.decodeRepeatedBytesField(value: &_storage._stringVal) }()
        case 9: try { try decoder.decodeRepeatedFloatField(value: &_storage._scomplexVal) }()
        case 10: try { try decoder.decodeRepeatedInt64Field(value: &_storage._int64Val) }()
        case 11: try { try decoder.decodeRepeatedBoolField(value: &_storage._boolVal) }()
        case 12: try { try decoder.decodeRepeatedDoubleField(value: &_storage._dcomplexVal) }()
        case 13: try { try decoder.decodeRepeatedInt32Field(value: &_storage._halfVal) }()
        case 14: try { try decoder.decodeRepeatedMessageField(value: &_storage._resourceHandleVal) }()
        case 15: try { try decoder.decodeRepeatedMessageField(value: &_storage._variantVal) }()
        case 16: try { try decoder.decodeRepeatedUInt32Field(value: &_storage._uint32Val) }()
        case 17: try { try decoder.decodeRepeatedUInt64Field(value: &_storage._uint64Val) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._tensorShape {
...
extension Tensorflow_VariantTensorDataProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.tensors) }()
      default: break
      }
    }
  }
