...
public struct Tensorflow_GraphDef {
  ...
  public var versions: Tensorflow_VersionDef {
    get {return _versions ?? Tensorflow_VersionDef()}
  ...
  public var library: Tensorflow_FunctionDefLibrary {
    get {return _library ?? Tensorflow_FunctionDefLibrary()}
    set {_library = newValue}
  }
  /// Returns true if `library` has been explicitly set.
  public var hasLibrary: Bool {return self._library != nil}
  ...
  fileprivate var _versions: Tensorflow_VersionDef? = nil
  fileprivate var _library: Tensorflow_FunctionDefLibrary? = nil
}
