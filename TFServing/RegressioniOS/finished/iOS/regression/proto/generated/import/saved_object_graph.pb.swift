...
public struct Tensorflow_SavedObjectGraph {
  ...
  public var concreteFunctions: Dictionary<String,Tensorflow_SavedConcreteFunction> = [:]
...
public struct Tensorflow_SavedObject {
  ...
  public var dependencies: [Tensorflow_TrackableObjectGraph.TrackableObject.ObjectReference] = []
  ...
  public var kind: Tensorflow_SavedObject.OneOf_Kind? = nil
  ...
  public var function: Tensorflow_SavedFunction {
    get {
      if case .function(let v)? = kind {return v}
      return Tensorflow_SavedFunction()
    }
  ...
  public var bareConcreteFunction: Tensorflow_SavedBareConcreteFunction {
    get {
      if case .bareConcreteFunction(let v)? = kind {return v}
      return Tensorflow_SavedBareConcreteFunction()
    }
    set {kind = .bareConcreteFunction(newValue)}
  }

  public var constant: Tensorflow_SavedConstant {
    get {
      if case .constant(let v)? = kind {return v}
      return Tensorflow_SavedConstant()
    }
    set {kind = .constant(newValue)}
  }

  public var resource: Tensorflow_SavedResource {
    get {
      if case .resource(let v)? = kind {return v}
      return Tensorflow_SavedResource()
    }
    set {kind = .resource(newValue)}
  }

  public var capturedTensor: Tensorflow_CapturedTensor {
    get {
      if case .capturedTensor(let v)? = kind {return v}
      return Tensorflow_CapturedTensor()
    }
  ...
  /// registered savers.
  public var saveableObjects: Dictionary<String,Tensorflow_SaveableObject> = [:]
  ...
  public var registeredName: String = String()
  ...
  public var serializedUserProto: SwiftProtobuf.Google_Protobuf_Any {
  ...
  public enum OneOf_Kind: Equatable {
    ...
    case function(Tensorflow_SavedFunction)
    case variable(Tensorflow_SavedVariable)
    case bareConcreteFunction(Tensorflow_SavedBareConcreteFunction)
    case constant(Tensorflow_SavedConstant)
    case resource(Tensorflow_SavedResource)
    case capturedTensor(Tensorflow_CapturedTensor)
    ...
    public static func ==(lhs: Tensorflow_SavedObject.OneOf_Kind, rhs: Tensorflow_SavedObject.OneOf_Kind) -> Bool {
      ...
      switch (lhs, rhs) {
      case (.userObject, .userObject): return {
        guard case .userObject(let l) = lhs, case .userObject(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      ...
      case (.bareConcreteFunction, .bareConcreteFunction): return {
        guard case .bareConcreteFunction(let l) = lhs, case .bareConcreteFunction(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      ...
      case (.resource, .resource): return {
        guard case .resource(let l) = lhs, case .resource(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.capturedTensor, .capturedTensor): return {
        guard case .capturedTensor(let l) = lhs, case .capturedTensor(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
public struct Tensorflow_SavedUserObject {
  ...
  public var version: Tensorflow_VersionDef {
    get {return _version ?? Tensorflow_VersionDef()}
  ...
  fileprivate var _version: Tensorflow_VersionDef? = nil
}
...
public struct Tensorflow_SavedFunction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var concreteFunctions: [String] = []

  public var functionSpec: Tensorflow_FunctionSpec {
    get {return _functionSpec ?? Tensorflow_FunctionSpec()}
    set {_functionSpec = newValue}
  }
  /// Returns true if `functionSpec` has been explicitly set.
  public var hasFunctionSpec: Bool {return self._functionSpec != nil}
  /// Clears the value of `functionSpec`. Subsequent reads from it will return its default value.
  public mutating func clearFunctionSpec() {self._functionSpec = nil}

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _functionSpec: Tensorflow_FunctionSpec? = nil
}

public struct Tensorflow_CapturedTensor {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var concreteFunction: String = String()
...
public struct Tensorflow_SavedConcreteFunction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var canonicalizedInputSignature: Tensorflow_StructuredValue {
    get {return _canonicalizedInputSignature ?? Tensorflow_StructuredValue()}
    set {_canonicalizedInputSignature = newValue}
  }
  /// Returns true if `canonicalizedInputSignature` has been explicitly set.
  public var hasCanonicalizedInputSignature: Bool {return self._canonicalizedInputSignature != nil}
  /// Clears the value of `canonicalizedInputSignature`. Subsequent reads from it will return its default value.
  public mutating func clearCanonicalizedInputSignature() {self._canonicalizedInputSignature = nil}

  /// Output that was the return value of this function after replacing all
  /// Tensors with TensorSpecs. This can be an arbitrary nested function and will
  /// be used to reconstruct the full structure from pure tensors.
  public var outputSignature: Tensorflow_StructuredValue {
    get {return _outputSignature ?? Tensorflow_StructuredValue()}
    set {_outputSignature = newValue}
  }
  /// Returns true if `outputSignature` has been explicitly set.
  public var hasOutputSignature: Bool {return self._outputSignature != nil}
  /// Clears the value of `outputSignature`. Subsequent reads from it will return its default value.
  public mutating func clearOutputSignature() {self._outputSignature = nil}

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _canonicalizedInputSignature: Tensorflow_StructuredValue? = nil
  fileprivate var _outputSignature: Tensorflow_StructuredValue? = nil
}

public struct Tensorflow_SavedBareConcreteFunction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Identifies a SavedConcreteFunction.
  public var concreteFunctionName: String = String()

  /// A sequence of unique strings, one per Tensor argument.
  public var argumentKeywords: [String] = []

  /// The prefix of `argument_keywords` which may be identified by position.
  public var allowedPositionalArguments: Int64 = 0
...
public struct Tensorflow_SavedConstant {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tensorflow_SavedVariable {
  ...
  public var experimentalDistributedVariableComponents: [Tensorflow_SavedVariable] = []
...
public struct Tensorflow_FunctionSpec {
  ...
  public var fullargspec: Tensorflow_StructuredValue {
    get {return _fullargspec ?? Tensorflow_StructuredValue()}
    set {_fullargspec = newValue}
  }
  /// Returns true if `fullargspec` has been explicitly set.
  public var hasFullargspec: Bool {return self._fullargspec != nil}
  /// Clears the value of `fullargspec`. Subsequent reads from it will return its default value.
  public mutating func clearFullargspec() {self._fullargspec = nil}
  ...
  public var inputSignature: Tensorflow_StructuredValue {
    get {return _inputSignature ?? Tensorflow_StructuredValue()}
    set {_inputSignature = newValue}
  }
  /// Returns true if `inputSignature` has been explicitly set.
  public var hasInputSignature: Bool {return self._inputSignature != nil}
  /// Clears the value of `inputSignature`. Subsequent reads from it will return its default value.
  public mutating func clearInputSignature() {self._inputSignature = nil}

  public var jitCompile: Tensorflow_FunctionSpec.JitCompile = .default
  ...
  public enum JitCompile: SwiftProtobuf.Enum {
  ...
  fileprivate var _fullargspec: Tensorflow_StructuredValue? = nil
  fileprivate var _inputSignature: Tensorflow_StructuredValue? = nil
}

#if swift(>=4.2)

extension Tensorflow_FunctionSpec.JitCompile: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_FunctionSpec.JitCompile] = [
    .default,
    .on,
    .off,
  ]
...
public struct Tensorflow_SavedResource {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tensorflow_SaveableObject {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var saveFunction: Int32 = 0

  public var restoreFunction: Int32 = 0
...
extension Tensorflow_SavedObjectGraph: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Tensorflow_SavedConcreteFunction>.self, value: &self.concreteFunctions) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.concreteFunctions.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Tensorflow_SavedConcreteFunction>.self, value: self.concreteFunctions, fieldNumber: 2)
    }
...
extension Tensorflow_SavedObject: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try {
        var v: Tensorflow_SavedFunction?
        var hadOneofValue = false
        if let current = self.kind {
          hadOneofValue = true
      ...
      case 8: try {
        var v: Tensorflow_SavedBareConcreteFunction?
        var hadOneofValue = false
        if let current = self.kind {
          hadOneofValue = true
      ...
      case 9: try {
        var v: Tensorflow_SavedConstant?
        var hadOneofValue = false
        if let current = self.kind {
          hadOneofValue = true
      ...
      case 10: try {
        var v: Tensorflow_SavedResource?
        var hadOneofValue = false
        if let current = self.kind {
          hadOneofValue = true
      ...
      case 11: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Tensorflow_SaveableObject>.self, value: &self.saveableObjects) }()
      case 12: try {
        var v: Tensorflow_CapturedTensor?
        var hadOneofValue = false
        if let current = self.kind {
          hadOneofValue = true
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.saveableObjects.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Tensorflow_SaveableObject>.self, value: self.saveableObjects, fieldNumber: 11)
    }
...
extension Tensorflow_SavedFunction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SavedFunction"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Tensorflow_SavedFunction, rhs: Tensorflow_SavedFunction) -> Bool {
    if lhs.concreteFunctions != rhs.concreteFunctions {return false}
...
extension Tensorflow_CapturedTensor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".CapturedTensor"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public static func ==(lhs: Tensorflow_CapturedTensor, rhs: Tensorflow_CapturedTensor) -> Bool {
...
extension Tensorflow_SavedConcreteFunction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SavedConcreteFunction"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Tensorflow_SavedConcreteFunction, rhs: Tensorflow_SavedConcreteFunction) -> Bool {
...
extension Tensorflow_SavedBareConcreteFunction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SavedBareConcreteFunction"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Tensorflow_SavedBareConcreteFunction, rhs: Tensorflow_SavedBareConcreteFunction) -> Bool {
...
extension Tensorflow_SavedConstant: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SavedConstant"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Tensorflow_SavedConstant, rhs: Tensorflow_SavedConstant) -> Bool {
...
extension Tensorflow_FunctionSpec.JitCompile: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Tensorflow_SavedResource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SavedResource"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "device"),
  ]
  ...
  public static func ==(lhs: Tensorflow_SavedResource, rhs: Tensorflow_SavedResource) -> Bool {
    if lhs.device != rhs.device {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Tensorflow_SaveableObject: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SaveableObject"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Tensorflow_SaveableObject, rhs: Tensorflow_SaveableObject) -> Bool {
