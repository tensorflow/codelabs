...
public enum Tensorflow_FullTypeId: SwiftProtobuf.Enum {
...
extension Tensorflow_FullTypeId: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Tensorflow_FullTypeId] = [
    .tftUnset,
    .tftVar,
    .tftAny,
    .tftProduct,
...
public struct Tensorflow_FullTypeDef {
  ...
  public var typeID: Tensorflow_FullTypeId = .tftUnset

  public var args: [Tensorflow_FullTypeDef] = []
  ...
  public var attr: Tensorflow_FullTypeDef.OneOf_Attr? = nil
  ...
  /// Shape-related types may admit int attributes - their static shape values.
  /// Fields for more data types to be added as needed.
  public enum OneOf_Attr: Equatable {
    case s(String)
    /// TODO(mdan): list/tensor, map? Need to reconcile with TFT_RECORD, etc.
    case i(Int64)

  #if !swift(>=4.1)
    public static func ==(lhs: Tensorflow_FullTypeDef.OneOf_Attr, rhs: Tensorflow_FullTypeDef.OneOf_Attr) -> Bool {
...
extension Tensorflow_FullTypeId: SwiftProtobuf._ProtoNameProviding {
...
extension Tensorflow_FullTypeDef: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".FullTypeDef"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Tensorflow_FullTypeDef, rhs: Tensorflow_FullTypeDef) -> Bool {
