...
public struct Tensorflow_ResourceHandleProto {
  ...
  public var dtypesAndShapes: [Tensorflow_ResourceHandleProto.DtypeAndShape] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  /// Protocol buffer representing a pair of (data type, tensor shape).
  public struct DtypeAndShape {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Tensorflow_ResourceHandleProto.DtypeAndShape: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Tensorflow_ResourceHandleProto.protoMessageName + ".DtypeAndShape"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "dtype"),
    2: .same(proto: "shape"),
  ]
  ...
  public static func ==(lhs: Tensorflow_ResourceHandleProto.DtypeAndShape, rhs: Tensorflow_ResourceHandleProto.DtypeAndShape) -> Bool {
